...
static void test_http_content_type_string (void) {
	...
	test_check_str_eq (http_content_type_string (HTTP_CONTENT_TYPE_JSON), content_type_json_string, NULL);
	test_check_str_eq (http_content_type_string (HTTP_CONTENT_TYPE_OCTET), content_type_octet_string, NULL);
	test_check_str_eq (http_content_type_string (HTTP_CONTENT_TYPE_JPG), content_type_jpg_string, NULL);
	test_check_str_eq (http_content_type_string (HTTP_CONTENT_TYPE_PNG), content_type_png_string, NULL);
	test_check_str_eq (http_content_type_string (HTTP_CONTENT_TYPE_ICO), content_type_ico_string, NULL);
...
static void test_http_content_type_description (void) {
	...
	test_check_str_eq (http_content_type_description (HTTP_CONTENT_TYPE_OCTET), content_type_octet_description, NULL);
...
static void test_http_content_type_by_string (void) {
	...
	test_check_unsigned_eq (http_content_type_by_string (content_type_text_description), HTTP_CONTENT_TYPE_HTML, NULL);
	test_check_unsigned_eq (http_content_type_by_string (content_type_css_description), HTTP_CONTENT_TYPE_CSS, NULL);
	test_check_unsigned_eq (http_content_type_by_string (content_type_js_description), HTTP_CONTENT_TYPE_JS, NULL);
	test_check_unsigned_eq (http_content_type_by_string (content_type_json_description), HTTP_CONTENT_TYPE_JSON, NULL);
	test_check_unsigned_eq (http_content_type_by_string (content_type_octet_description), HTTP_CONTENT_TYPE_OCTET, NULL);
	test_check_unsigned_eq (http_content_type_by_string (content_type_jpg_description), HTTP_CONTENT_TYPE_JPG, NULL);
	test_check_unsigned_eq (http_content_type_by_string (content_type_png_description), HTTP_CONTENT_TYPE_PNG, NULL);
	test_check_unsigned_eq (http_content_type_by_string (content_type_ico_description), HTTP_CONTENT_TYPE_ICO, NULL);
	test_check_unsigned_eq (http_content_type_by_string (content_type_gif_description), HTTP_CONTENT_TYPE_GIF, NULL);
	test_check_unsigned_eq (http_content_type_by_string (content_type_audio_description), HTTP_CONTENT_TYPE_MP3, NULL);

}

static void test_http_content_type_by_extension (void) {

	test_check_str_eq (http_content_type_by_extension (content_type_text_string), content_type_text_description, NULL);
	test_check_str_eq (http_content_type_by_extension (content_type_css_string), content_type_css_description, NULL);
	test_check_str_eq (http_content_type_by_extension (content_type_js_string), content_type_js_description, NULL);
	test_check_str_eq (http_content_type_by_extension (content_type_json_string), content_type_json_description, NULL);
	test_check_str_eq (http_content_type_by_extension (content_type_octet_string), content_type_octet_description, NULL);
	test_check_str_eq (http_content_type_by_extension (content_type_jpg_string), content_type_jpg_description, NULL);
	test_check_str_eq (http_content_type_by_extension (content_type_png_string), content_type_png_description, NULL);
	test_check_str_eq (http_content_type_by_extension (content_type_ico_string), content_type_ico_description, NULL);
	test_check_str_eq (http_content_type_by_extension (content_type_gif_string), content_type_gif_description, NULL);
	test_check_str_eq (http_content_type_by_extension (content_type_audio_string), content_type_audio_description, NULL);
