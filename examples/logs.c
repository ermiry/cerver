...
int main (int argc, char **argv) {
	...
	char *name = "Erick Salas";
	int num = 10;
	cerver_log (LOG_TYPE_SUCCESS, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
	cerver_log (LOG_TYPE_ERROR, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
	cerver_log (LOG_TYPE_WARNING, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
	cerver_log (LOG_TYPE_TEST, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
	cerver_log (LOG_TYPE_CERVER, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
	cerver_log (LOG_TYPE_CLIENT, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
	cerver_log (LOG_TYPE_HANDLER, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
	cerver_log (LOG_TYPE_ADMIN, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
	cerver_log (LOG_TYPE_EVENT, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
	cerver_log (LOG_TYPE_PACKET, LOG_TYPE_CERVER, "Hola %s yo soy el numero %d", name, num);
