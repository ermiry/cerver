...
CERVER_EXPORT DoubleList *http_request_multi_parts_get_all_filenames (HttpRequest *http_request);

// returns a dlist with constant strings values (that should not be deleted) with all the saved filenames from the request
// the dlist must be deleted using http_request_multi_parts_all_filenames_delete ()
CERVER_EXPORT DoubleList *http_request_multi_parts_get_all_saved_filenames (HttpRequest *http_request);
...
CERVER_EXPORT void http_request_multi_parts_filenames_delete (DoubleList *all_filenames);
