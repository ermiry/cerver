...
examples: $(EXAMPLES)
	...
	$(CC) -g -Wall -Wno-unknown-pragmas -I ./include -L ./bin ./examples/logs.c -o ./examples/bin/logs -l cerver
	...
	$(CC) -g -Wall -Wno-unknown-pragmas -I ./include -L ./bin ./examples/web/sockets.c -o ./examples/bin/web/sockets -l cerver
